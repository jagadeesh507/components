...
function BlogSection49() {
  ...
  return (
    <div className="text-center p-4 md:p-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 md:pt-20 pb-4 md:pb-10">
        {Array.from({ length: 4 }, (_, index) => (
          <div key={index} className="card  md:card-side">
            <figure>
              <img
